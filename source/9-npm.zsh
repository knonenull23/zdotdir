...
create() {
  case ${1:-$#} in
        alfred*) npx create @$GITHUB_USER/alfred-workflow;;
        vscode*) npx create @$GITHUB_USER/vscode-extension;;
    qwik*coffee) npx create qwik-coffee;;
      git*hooks) npx create git-hooks;;
              0) npm init;;
              *) npx create @$GITHUB_USER
  esac
}
